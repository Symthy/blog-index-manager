...
def put_hatena_summary_page(blog_config: BlogConfig, category_group_def: CategoryGroupDef):
    """
...
def push_blog_and_photo_entry(blog_config, doc_entry: DocEntry,
...
# public: for testing
def push_photo_entries(blog_config, doc_entry: DocEntry, old_photo_entries: Optional[PhotoEntries] = None) \
